...
from ByrdLab.decentralizedAlgorithm import DSGD, SimiliarityReweighting
...
elif args.graph == 'ER_N20B2':
    honest_size = 20
    byzantine_size = 2
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B3':
    honest_size = 20
    byzantine_size = 3
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B4':
    honest_size = 20
    byzantine_size = 4
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B5':
    honest_size = 20
    byzantine_size = 5
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B6':
    honest_size = 20
    byzantine_size = 6
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B7':
    honest_size = 20
    byzantine_size = 7
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B8':
    honest_size = 20
    byzantine_size = 8
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B9':
    honest_size = 20
    byzantine_size = 9
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
elif args.graph == 'ER_N20B10':
    honest_size = 20
    byzantine_size = 10
    node_size = honest_size + byzantine_size
    graph = ErdosRenyi(node_size, byzantine_size, seed=300)
...
elif args.attack == 'sign_flipping_0.1':
    attack = D_sign_flipping(graph, scale=0.1)
...
# initilize optimizer
env = SimiliarityReweighting(graph=graph, attack=attack,
